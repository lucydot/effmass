...
The `effmass` package is aimed towards theoretical solid state physicists and chemists who have a basic familiriarity with Python. If you are looking to calculate the parabolic effective mass only, and would prefer a command line interface, it may be that one of the packages listed below will suit your needs better.
